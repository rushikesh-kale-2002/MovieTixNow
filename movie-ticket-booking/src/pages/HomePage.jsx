...
const HomePage = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <div className="homepage-layout">
      {/* Collapsible Sidebar - Simplified without floating toggle */}
      <GenreSidebar isOpen={sidebarOpen} setIsOpen={setSidebarOpen} />

      {/* Main Content - Adjusts based on sidebar state */}
      <div
        className={`main-content-with-sidebar ${sidebarOpen ? "sidebar-open" : "sidebar-closed"}`}
